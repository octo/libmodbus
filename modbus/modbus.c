                       ...
                       int query_length)
{
        ...
        if (mb_param->obj->type_com == RTU)
                ...
                ret = send(mb_param->obj->fd, query, query_length, MSG_NOSIGNAL);
...
{                                                                                  \
    ...
    if (select_ret == 0) {                                                         \
            /* Timeout */                                                          \
            if (msg_length == (TAB_HEADER_LENGTH[mb_param->obj->type_com] + 2 +    \
                               TAB_CHECKSUM_LENGTH[mb_param->obj->type_com])) {    \
